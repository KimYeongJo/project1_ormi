...
for (i = 0; i < id.length; i++) {
    ...
    $input.classList.add('border-black', 'border-solid', 'rounded-full', 'm-2',
                         'p-2', 'pl-4', 'text-black')
...
$btn.classList.add('m-2', 'mt-5', 'p-2', 'border-black', 'border-solid', 'rounded-full',
